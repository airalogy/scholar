...
hero:
  name: Scholar 文档
  text: 使用、管理与系统接入指南
  tagline: 与 Scholar 产品版本同步交付，帮助机构管理员和系统集成人员安全地管理学术数据。
  actions:
    - theme: brand
      text: 查看机构接入指南
      link: /zh/integration/
...
features:
  ...
  - title: 可执行 API 参考
    details: 通过 Scholar 提供的 Swagger UI 查看当前版本的完整请求结构和响应 Schema。
  - title: 中英文对照
...
::: tip 当前产品版本
本文档适用于 Scholar `v{{ $frontmatter.scholarVersion }}`。接口字段以当前 Scholar 实例的 [OpenAPI 文档](/zh/reference/openapi)为准。
:::
