...
hero:
  ...
  tagline: Versioned with Airalogy Scholar to help institution administrators and system integrators manage academic data securely.
  actions:
    - theme: brand
...
features:
  ...
  - title: Executable API reference
    details: Use Airalogy Scholar's Swagger UI to inspect the exact request and response schemas for the current version.
...
::: tip Product version
This documentation applies to Airalogy Scholar `v{{ $frontmatter.scholarVersion }}`. Refer to the current Airalogy Scholar instance's [OpenAPI reference](/en/reference/openapi) for exact field definitions.
:::
